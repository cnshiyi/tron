...
- `.env.example` 已补齐 `PUBLIC_BASE_URL`、`TRON_NETWORK`、`TELEGRAM_SEND_ENABLED`、`SOHU_SEND_ENABLED`、`WITHDRAWAL_PAYOUT_ENABLED` 等开关。
- 新增命令 `check_online_readiness`，用于检查公网地址、Trongrid Key、机器人 token、质押账户等是否就绪。
