...
TELEGRAM_DELIVERY_MODE = os.getenv("TELEGRAM_DELIVERY_MODE", "polling").strip().lower()
TELEGRAM_SEND_ENABLED = os.getenv("TELEGRAM_SEND_ENABLED", "0") == "1"
SOHU_SEND_ENABLED = os.getenv("SOHU_SEND_ENABLED", "0") == "1"
WITHDRAWAL_PAYOUT_ENABLED = os.getenv("WITHDRAWAL_PAYOUT_ENABLED", "0") == "1"
WITHDRAWAL_PRIVATE_KEY = os.getenv("WITHDRAWAL_PRIVATE_KEY", "")
