...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        add("PUBLIC_BASE_URL", bool(settings.PUBLIC_BASE_URL), settings.PUBLIC_BASE_URL or "未配置公网地址，无法设置 Telegram Webhook")
        ...
        required = ["PUBLIC_BASE_URL", "TRONGRID_API_KEY", "Bot token", "StakingAccount"]
